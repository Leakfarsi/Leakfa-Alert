const LEAKFA_STRINGS = {
    en: {
        ...
        checkOnLeakfa: 'Check on Leakfa',
        checkMajorLeaks: 'List of Leaks',
        notificationOff: 'Notification: Off',
        notificationOnce: 'Notification: Once',
        notificationEveryTime: 'Notification: Always',
        ...
        offLabel: 'OFF',
        notifModeOff: 'Off',
        notifModeOnce: 'On (Once per Site)',
        notifModeEveryTime: 'On (Always)',
    ...
    fa: {
        ...
        checkOnLeakfa: 'بررسی در لیکفا',
        checkMajorLeaks: 'فهرست نشت‌ها',
        notificationOff: 'اعلان: خاموش',
        notificationOnce: 'اعلان: یک‌بار',
        notificationEveryTime: 'اعلان: همیشه',
        settingsTitle: 'تنظیمات افزونه',
        navSettings: 'تنظیمات',
        navGeneral: 'عمومی',
        navHistory: 'تاریخچه',
        navAbout: 'درباره',
        notificationSettingsHeading: 'تنظیمات اعلان',
        onLabel: 'روشن',
        offLabel: 'خاموش',
        notifModeOff: 'خاموش',
        notifModeOnce: 'روشن (یک‌بار برای هر سایت)',
        notifModeEveryTime: 'روشن (همیشه)',
...
function leakfaResolveLeakStatus(entry) {
    return (entry && entry.status === 'reported') ? 'reported' : 'confirmed';
}
